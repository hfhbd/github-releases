...
publishing {
    repositories {
        maven(url = "https://maven.pkg.github.com/hfhbd/githubreleases") {
            name = "GitHubPackages"
    ...
    publications.withType<MavenPublication>().configureEach {
        pom {
            name.set("hfhbd githubreleases")
            description.set("hfhbd githubreleases")
            url.set("https://github.com/hfhbd/githubreleases")
            licenses {
                license {
                    name.set("Apache-2.0")
            ...
            scm {
                connection.set("scm:git://github.com/hfhbd/githubreleases.git")
                developerConnection.set("scm:git://github.com/hfhbd/githubreleases.git")
                url.set("https://github.com/hfhbd/githubreleases")
            }
            distributionManagement {
                repository {
                    ...
                    url = "https://maven.pkg.github.com/hfhbd/githubreleases"
                }
            }
        }
    }
